...
from app.db.fake_db import aplications_db, jobs_db
from app.schemas.aplication_schema import ApplicationResponse
...
async def add_aplication_service(job_id: int, current_user: UserResponse, status: str = 'sent') -> ApplicationResponse:
